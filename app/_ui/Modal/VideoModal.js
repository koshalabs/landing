export default function VideoModal({handleCloseModal}) {
    return <div className="bg-white overflow-y-auto w-[calc(100svw-32px)] footerPhoneBreak:w-[calc(100svw-80px)] max-w-[1360px] modalShadow text-koshaBlack relative modalWindow aspect-video max-h-[calc(100dvh-100px)] overflow-x-hidden">
