...
export default function HeroSection() {
    return <section className="h-[642px] lg:h-[728px] mx-4 rounded-3xl footerPhoneBreak:mx-10 mb-10 bg-[url('/Hero-mobile.png')] md:bg-[url('/Hero.png')] bg-cover text-white pt-[147px] lg:pt-[156px] pl-6 koshaHeroBreak:pl-20 mt-[85px] pr-6 koshaHeroBreak:pr-0">
